...
import { Users, TrendingUp, ShoppingBag, DollarSign, RefreshCw, ChevronLeft, ChevronRight, Download, Filter, X, Maximize2, Minimize2 } from 'lucide-react'
...
export const CustomerAnalysisFixed: React.FC = () => {
  ...
  }, [selectedPeriod, currentPage, itemsPerPage, regionFilter, cityFilter, chainFilter, salesmanFilter, routeFilter, searchQuery, classificationFilter])
  ...
  const hasActiveFilters = regionFilter || cityFilter || chainFilter || salesmanFilter || routeFilter || searchQuery || classificationFilter
                  ...
                  {loading ? (
                    ...
                    data.topCustomers.map((customer: CustomerData) => (
                      <TableRow key={customer.customerCode}>
                        ...
                        <TableCell>{customer.region || 'Unknown'}</TableCell>
                        <TableCell>{customer.city || 'Unknown'}</TableCell>
                        <TableCell>{customer.chain || 'Unknown'}</TableCell>
                        <TableCell>{customer.routeName || 'Unknown'}</TableCell>
                        <TableCell>{customer.salesmanName || 'Unknown'}</TableCell>
